...
export type NormalizedRaceResults={catalogId:string;raceId:number;raceName:string;raceDate:string;location?:Partial<Location>;imageUrl?:string;provider:"RunSignup";raceUrl:string;availability:"available"|"pending"|"unavailable";resultSets:ResultSetSummary[];lastChecked:string;providerStatus?:"ok"|"error"};
